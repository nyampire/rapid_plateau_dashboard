...
function renderDashboard(D) {
  ...
  // Toner raster tiles from the OSMFJ tile server (Japanese labels, no API key).
  // We moved off CARTO's dark basemap: its free tier now requires a key and stamps
  // "API KEY REQUIRED" across every tile. Attribution required.
  L.tileLayer("https://tile.openstreetmap.jp/styles/maptiler-toner-ja/{z}/{x}/{y}.png",
    { maxZoom: 20, opacity: 0.9,
      attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://www.openmaptiles.org/">OpenMapTiles</a>' }).addTo(map);
  L.geoJSON(D.geojson, {
    style: (f) => {
